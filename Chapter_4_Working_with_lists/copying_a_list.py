...
print("\nNow the output of copy_list without doing any modification after \
    assignment: ")
print(copy_list)

print("\nThis is because assignment don't duplicate de value of the object,\
    what really happens is that object reference of z_warriors is assigned to \
    copy_list.")

print("\nHence, z_warriors and copy_list are diferent variables but refers to \
    the same object.")
